...
if(isset($_POST['approveBtn'])){
    ...
    $update="UPDATE clients SET status='Approved' WHERE client_id='$hID' AND user='Client'";
...
<h3><span class="semi-bold">Customers pending approval</span></h3>
</div>
<div class="row">
<div class="col-md-12">
    ...
    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
        ...
        while($row=mysqli_fetch_array($query)){
            ...
            <tr class="odd gradeX">
                ...
                <td>
                    <a href="#"data-toggle="modal" data-target="#ModalA<?php echo $row['client_id']?>"
                       class="btn-link ">Activate</a>
                    <a href="#"data-toggle="modal" data-target="#ModalR<?php echo $row['client_id']?>"
                       class="btn-link bg-danger">Reject</a>
                </td>
